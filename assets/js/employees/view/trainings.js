...
function editForm (info) {
    ...
    $('#editModal').find('input[name=type]').val(info.type);
    $('#editModal').find('input[name=sponsor]').val(info.sponsor);
    $('#editModal').modal();
}
...
function deleteData (id) {
    swal({
        ...
        showLoading();
        let url = base_url + 'employee/Delete_employee/training/' + $('#employee-id').val();
