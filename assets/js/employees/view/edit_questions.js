$(function () {    
    ...
    $('form').submit(function (e) {
        ...
        let url = base_url + 'employee/Update_employee/questions/' + $('#employee-id').val();
        let data = new FormData(this);
        console.log(data.get('fourth_degree_details'))
        swal({
            ...
            ajaxPost(url, data)
                .then(result => {
                    setTimeout(() => { location.replace(base_url + 'Employees/view/' + $('#employee-id').val() + '/questions') }, 1000);
